			...
			<div class="content-topbar flex-sb-m h-full container">
				...
				<div class="right-top-bar flex-w h-full">
					<ul class="social">
						...
						<li class="youtube"><a href="{{$contact->google_plus}}" target="_blank"><i class="fa fa-youtube-play"></i></a></li>
			...
			<nav class="limiter-menu-desktop container">
				...
				<div class="wrap-icon-header flex-w flex-r-m">
					<div class="icon-header-item cl2 hov-cl1 trans-04
						 p-l-22 p-r-11 icon-header-noti js-show-cart" data-notify="{{Cart::count()}}">
			...
			<li>
				<div class="right-top-bar flex-w h-full">
					<ul class="social">
						...
						<li class="youtube"><a href="{{$contact->youtube}}"><i class="fa fa-youtube-play" target="_blank"></i></a></li>
				...
				<li class="header-cart-item flex-w flex-t m-b-12">
					<div class="header-cart-item-img">
						<img src="{{asset('public/upload/
											product_images/'.$content->options->image)}}" alt="IMG" ;>
					</div>
