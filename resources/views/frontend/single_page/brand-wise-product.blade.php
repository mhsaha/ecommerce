		...
		<div class="flex-w flex-sb-m p-b-52">
			<div class="flex-w flex-l-m filter-tope-group m-tb-10">
				...
				<a class="stext-106 cl6 hov1 bor3 trans-04 m-r-32 m-tb-5
					 how-active1" data-filter="*" href="{{route('category.wise.product',$category->category_id)}}">{{$category['category'] ['name']}}</a>
				@endforeach
			...
			<div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item women">
				...
				<div class="block2">
					<div class="block2-pic hov-img0">
						<img src="{{asset('public/upload/product_images/'.$product->image)}}" alt="IMG-PRODUCT">
