                        ...
                        <div class="card-header">
                            <h3>Edit Slider
                                <a class="btn btn-success float-right btn-sm" href="{{route('sliders.view')}}">
                                    <i class="fa fa-list"></i> Slider Lists</a>
                            </h3>
                        </div>
                    </div>
                    <!-- /.card-header -->
                        ...
                        <form method="post" action="{{route('sliders.update',$editData->id)}}" id="myForm" enctype="multipart/form-data">
                            ...
                            <div class="form-row">
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="text" name="long_title" value="{{$editData->long_title}}" class="from-control">
                                </div>
                                ...
                                <div class="form-group col-md-2">
                                    ...
                                    ?url('public/upload/slider_images/'.$editData->image):url 
