                        ...
                        <form method="post" action="{{route('contacts.update',$editData->id)}}" id="myForm"  enctype ="multipart/form-data">
                            ...
                            <div class="form-row">
                                ...
                                <div class="form-group col-md-4">
                                    ...
                                    <input type="text" name="facebook" value="{{$editData->facebook}}"class="from-control">
                                </div>
                                <div class="form-group col-md-4">
                                    <label for="twitter">Twitter</label>
                                    <input type="text" name="twitter" value="{{$editData->twitter}}"class="from-control">
                                    
                                </div>
                                <div class="form-group col-md-4">
                                    <label for="youtube">Youtube</label>
                                    <input type="text" name="youtube" value="{{$editData->youtube}}"class="from-control">
                                    
                                </div>
                                <div class="form-group col-md-4">
                                    <label for="google_plus">Google plus</label>
                                    <input type="text" name="google_plus" value="{{$editData->google_plus}}"class="from-control">
                                </div>
