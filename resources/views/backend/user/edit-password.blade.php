                        ...
                        <form method="post" action="{{route('profiles.password.update')}}" id="myForm">
                            ...
                            <div class="form-row">
                                ...
                                <div class="form-group col-md-4">
                                    ...
                                    <input type="password" name="current_password" class="from-control">
                                </div>

                                <div class="form-group col-md-4">
                                    <label for="new_password"> New Password</label>
                                    <input type="password" name="new_password" id="new_password"class="from-control">
                                </div>
                                <div class="form-group col-md-4">
                                    <label for="again_new_password">Again New password</label>
                                    <input type="password" name="again_new_password" class="from-control">
                                </div>
